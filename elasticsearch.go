...
// ELASTICSEARCH contents the information to connect with ElasticSearch
...
func (es *ELASTICSEARCH) createIndexIfNotExist() error {
	...
	if !createIndex.Acknowledged {
		err = fmt.Errorf("expected IndicesCreateResult.Acknowledged %v; got %v", true, createIndex.Acknowledged)
	}
